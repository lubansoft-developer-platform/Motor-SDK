...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './GeometryAttributes-9d45f9e2', './GeometryPipeline-57d51dc8', './IndexDatatype-e52361bd', './WebMercatorProjection-c32b7757'], function (exports, when, Check, Cartesian2, BoundingSphere, Matrix4, ComponentDatatype, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, WebMercatorProjection) { 'use strict';
    ...
    function transformToWorldCoordinates(instances, primitiveModelMatrix, scene3DOnly) {
            ...
            if (!toWorld && (length > 1)) {
                ...
                for (i = 1; i < length; ++i) {
                    if (!Matrix4.Matrix4.equals(modelMatrix, instances[i].modelMatrix)) {
                        toWorld = true;
                        break;
                    }
                }
            ...
            if (toWorld) {
                ...
                Matrix4.Matrix4.multiplyTransformation(primitiveModelMatrix, instances[0].modelMatrix, primitiveModelMatrix);
            }
        }
        ...
        function packInstancesForCombine(instances, transferableObjects) {
            ...
            for (var i = 0; i < length; i++) {
                var instance = instances[i];
                Matrix4.Matrix4.pack(instance.modelMatrix, packedData, count);
                count += Matrix4.Matrix4.packedLength;
        ...
        function unpackInstancesForCombine(data) {
            ...
            while (i < packedInstances.length) {
                var modelMatrix = Matrix4.Matrix4.unpack(packedInstances, i);
                var attributes;
                i += Matrix4.Matrix4.packedLength;
        ...
        PrimitivePipeline.unpackCombineGeometryParameters = function(packedParameters) {
            ...
            return {
                ...
                modelMatrix : Matrix4.Matrix4.clone(packedParameters.modelMatrix),
...
//# sourceMappingURL=PrimitivePipeline-185efa6e.js.map
