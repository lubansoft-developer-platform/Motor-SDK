...
define(['./when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './RuntimeError-86da6af2', './Rectangle-c7d55cfa', './WebGLConstants-3660bc8f', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab', './GeometryAttributes-9d45f9e2', './AttributeCompression-1e177d5e', './GeometryPipeline-57d51dc8', './EncodedCartesian3-7b803d4a', './IndexDatatype-e52361bd', './IntersectionTests-8855da40', './Plane-1875afb4', './GeometryOffsetAttribute-f755a5cb', './VertexFormat-a00562ee', './GeometryInstance-734856d8', './EllipsoidRhumbLine-4bc7760a', './PolygonPipeline-d22f3330', './RectangleGeometryLibrary-2696ecaf'], function (when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, RuntimeError, Rectangle, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, AttributeCompression, GeometryPipeline, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane, GeometryOffsetAttribute, VertexFormat, GeometryInstance, EllipsoidRhumbLine, PolygonPipeline, RectangleGeometryLibrary) { 'use strict';
    ...
    var positionScratch = new Cartesian3.Cartesian3();
        ...
        function calculateAttributes(positions, vertexFormat, ellipsoid, tangentRotationMatrix) {
            ...
            if (vertexFormat.normal || vertexFormat.tangent || vertexFormat.bitangent) {
                for (var i = 0; i < length; i += 3) {
                    var p = Cartesian3.Cartesian3.fromArray(positions, i, positionScratch);
                    ...
                    if (vertexFormat.tangent || vertexFormat.bitangent) {
                        ...
                        Matrix4.Matrix3.multiplyByVector(tangentRotationMatrix, tangent, tangent);
                        Cartesian3.Cartesian3.normalize(tangent, tangent);

                        if (vertexFormat.bitangent) {
                            Cartesian3.Cartesian3.normalize(Cartesian3.Cartesian3.cross(normal, tangent, bitangent), bitangent);
                        }
                    }
        ...
        var v1Scratch = new Cartesian3.Cartesian3();
        var v2Scratch = new Cartesian3.Cartesian3();
        ...
        function calculateAttributesWall(positions, vertexFormat, ellipsoid) {
            ...
            if (vertexFormat.normal || vertexFormat.tangent || vertexFormat.bitangent) {
                for (var i = 0; i < length; i += 6) {
                    var p = Cartesian3.Cartesian3.fromArray(positions, i, positionScratch);
                    var p1 = Cartesian3.Cartesian3.fromArray(positions, (i + 6) % length, v1Scratch);
                    if (recomputeNormal) {
                        var p2 = Cartesian3.Cartesian3.fromArray(positions, (i + 3) % length, v2Scratch);
                        Cartesian3.Cartesian3.subtract(p1, p, p1);
                        Cartesian3.Cartesian3.subtract(p2, p, p2);
                        normal = Cartesian3.Cartesian3.normalize(Cartesian3.Cartesian3.cross(p2, p1, normal), normal);
                        recomputeNormal = false;
                    }

                    if (Cartesian3.Cartesian3.equalsEpsilon(p1, p, Cartesian3.CesiumMath.EPSILON10)) { // if we've reached a corner
        ...
        function constructExtrudedRectangle(rectangleGeometry, computedOptions) {
            ...
            for (i = 0; i < length - 1; i += 2) {
                ...
                var p1 = Cartesian3.Cartesian3.fromArray(wallPositions, upperLeft * 3, v1Scratch);
                var p2 = Cartesian3.Cartesian3.fromArray(wallPositions, upperRight * 3, v2Scratch);
                if (Cartesian3.Cartesian3.equalsEpsilon(p1, p2, Cartesian3.CesiumMath.EPSILON10)) {
                    continue;
                }
        ...
        var scratchRectanglePoints = [new Cartesian3.Cartesian3(), new Cartesian3.Cartesian3(), new Cartesian3.Cartesian3(), new Cartesian3.Cartesian3()];
        ...
        function computeRectangle(rectangle, granularity, rotation, ellipsoid, result) {
            if (rotation === 0.0) {
                return Rectangle.Rectangle.clone(rectangle, result);
            }
            ...
            return Rectangle.Rectangle.fromCartesianArray(positions, ellipsoid, result);
        }
        ...
        function RectangleGeometry(options) {
            ...
            Rectangle.Rectangle.validate(rectangle);
            ...
            this._rectangle = Rectangle.Rectangle.clone(rectangle);
         ...
         * @type {Number}
         */
        RectangleGeometry.packedLength = Rectangle.Rectangle.packedLength + Cartesian2.Ellipsoid.packedLength + VertexFormat.VertexFormat.packedLength + 7;
        ...
        RectangleGeometry.pack = function(value, array, startingIndex) {
            ...
            Rectangle.Rectangle.pack(value._rectangle, array, startingIndex);
            startingIndex += Rectangle.Rectangle.packedLength;
        ...
        RectangleGeometry.unpack = function(array, startingIndex, result) {
            ...
            var rectangle = Rectangle.Rectangle.unpack(array, startingIndex, scratchRectangle);
            startingIndex += Rectangle.Rectangle.packedLength;
            ...
            result._rectangle = Rectangle.Rectangle.clone(rectangle, result._rectangle);
        ...
        var tangentRotationMatrixScratch = new Matrix4.Matrix3();
        ...
        RectangleGeometry.createGeometry = function(rectangleGeometry) {
            if ((Cartesian3.CesiumMath.equalsEpsilon(rectangleGeometry._rectangle.north, rectangleGeometry._rectangle.south, Cartesian3.CesiumMath.EPSILON10) ||
                 (Cartesian3.CesiumMath.equalsEpsilon(rectangleGeometry._rectangle.east, rectangleGeometry._rectangle.west, Cartesian3.CesiumMath.EPSILON10)))) {
                return undefined;
            }
            ...
            if (stRotation !== 0 || rotation !== 0) {
                var center = Rectangle.Rectangle.center(rectangle, centerScratch);
                ...
                Matrix4.Matrix3.fromQuaternion(quaternionScratch, tangentRotationMatrix);
            } else {
                Matrix4.Matrix3.clone(Matrix4.Matrix3.IDENTITY, tangentRotationMatrix);
            }

            var surfaceHeight = rectangleGeometry._surfaceHeight;
            var extrudedHeight = rectangleGeometry._extrudedHeight;
            var extrude = !Cartesian3.CesiumMath.equalsEpsilon(surfaceHeight, extrudedHeight, 0, Cartesian3.CesiumMath.EPSILON2);
        ...
        var unrotatedTextureRectangleScratch = new Rectangle.Rectangle();
        ...
        function textureCoordinateRotationPoints(rectangleGeometry) {
            ...
            var rectangle = Rectangle.Rectangle.clone(rectangleGeometry._rectangle, unrotatedTextureRectangleScratch);
            var granularity = rectangleGeometry._granularity;
            var ellipsoid = rectangleGeometry._ellipsoid;
            ...
            var boundingRectangleCenter = Rectangle.Rectangle.center(boundingRectangle, rectangleCenterScratch);
    ...
    function createRectangleGeometry(rectangleGeometry, offset) {
            ...
            rectangleGeometry._rectangle = Rectangle.Rectangle.clone(rectangleGeometry._rectangle);
