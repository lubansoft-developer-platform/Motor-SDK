...
define(['./when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './RuntimeError-86da6af2', './Rectangle-c7d55cfa', './WebGLConstants-3660bc8f', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab', './GeometryAttributes-9d45f9e2', './IndexDatatype-e52361bd', './IntersectionTests-8855da40', './Plane-1875afb4', './GeometryOffsetAttribute-f755a5cb', './arrayRemoveDuplicates-24a803e7', './EllipsoidTangentPlane-3e14dd4d', './EllipsoidRhumbLine-4bc7760a', './PolygonPipeline-d22f3330', './PolylineVolumeGeometryLibrary-3867ede1', './EllipsoidGeodesic-1d7258d7', './PolylinePipeline-5cc41d8c', './CorridorGeometryLibrary-4c512a69'], function (when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, RuntimeError, Rectangle, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, IndexDatatype, IntersectionTests, Plane, GeometryOffsetAttribute, arrayRemoveDuplicates, EllipsoidTangentPlane, EllipsoidRhumbLine, PolygonPipeline, PolylineVolumeGeometryLibrary, EllipsoidGeodesic, PolylinePipeline, CorridorGeometryLibrary) { 'use strict';
    ...
    var cartesian1 = new Cartesian3.Cartesian3();
        ...
        function CorridorOutlineGeometry(options) {
             ...
             * @type {Number}
             */
            this.packedLength = 1 + positions.length * Cartesian3.Cartesian3.packedLength + Cartesian2.Ellipsoid.packedLength + 6;
        }
