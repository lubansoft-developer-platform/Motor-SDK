...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './GeometryAttributes-9d45f9e2', './IndexDatatype-e52361bd', './GeometryOffsetAttribute-f755a5cb', './VertexFormat-a00562ee', './CylinderGeometryLibrary-fae5a922'], function (exports, when, Check, Cartesian3, Cartesian2, BoundingSphere, ComponentDatatype, GeometryAttribute, PrimitiveType, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, VertexFormat, CylinderGeometryLibrary) { 'use strict';
    ...
    var radiusScratch = new Cartesian2.Cartesian2();
        ...
        CylinderGeometry.createGeometry = function(cylinderGeometry) {
            ...
            if (computeNormal) {
                ...
                for (i = 0; i < slices; i++) {
                    var angle = i / slices * Cartesian3.CesiumMath.TWO_PI;
            ...
            if (vertexFormat.st) {
                ...
                for (i = 0; i < numVertices; i++) {
                    var position = Cartesian3.Cartesian3.fromArray(positions, i * 3, positionScratch);
            ...
            var boundingSphere = new BoundingSphere.BoundingSphere(Cartesian3.Cartesian3.ZERO, Cartesian2.Cartesian2.magnitude(radiusScratch));
...
//# sourceMappingURL=CylinderGeometry-e5757843.js.map
