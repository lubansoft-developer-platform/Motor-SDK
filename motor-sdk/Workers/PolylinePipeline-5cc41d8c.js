...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './Matrix4-c65e6a1b', './IntersectionTests-8855da40', './Plane-1875afb4', './EllipsoidRhumbLine-4bc7760a', './EllipsoidGeodesic-1d7258d7'], function (exports, when, Check, Cartesian3, Cartesian2, Matrix4, IntersectionTests, Plane, EllipsoidRhumbLine, EllipsoidGeodesic) { 'use strict';
    ...
    /**
         ...
         * @returns {Boolean}
         */
         PolylinePipeline.getTriangleArea = function(positions){
            let v1 = Cartesian3.Cartesian3.subtract(positions[0], positions[1], new Cartesian3.Cartesian3());
            let v2 = Cartesian3.Cartesian3.subtract(positions[0], positions[2], new Cartesian3.Cartesian3());
            let v3 = Cartesian3.Cartesian3.cross(v1, v2, new Cartesian3.Cartesian3());
            return Cartesian3.Cartesian3.magnitude(v3)*0.5;
        };

        PolylinePipeline.numberOfPoints = function(p0, p1, minDistance) {
            var distance = Cartesian3.Cartesian3.distance(p0, p1);
        ...
        var wrapLongitudeInversMatrix = new Matrix4.Matrix4();
        var wrapLongitudeOrigin = new Cartesian3.Cartesian3();
        var wrapLongitudeXZNormal = new Cartesian3.Cartesian3();
        var wrapLongitudeXZPlane = new Plane.Plane(Cartesian3.Cartesian3.UNIT_X, 0.0);
        var wrapLongitudeYZNormal = new Cartesian3.Cartesian3();
        var wrapLongitudeYZPlane = new Plane.Plane(Cartesian3.Cartesian3.UNIT_X, 0.0);
        var wrapLongitudeIntersection = new Cartesian3.Cartesian3();
        var wrapLongitudeOffset = new Cartesian3.Cartesian3();
        ...
        var cartesian = new Cartesian3.Cartesian3();
        var scaleFirst = new Cartesian3.Cartesian3();
        var scaleLast = new Cartesian3.Cartesian3();
        ...
        PolylinePipeline.wrapLongitude = function(positions, modelMatrix) {
            ...
            if (when.defined(positions) && positions.length > 0) {
                modelMatrix = when.defaultValue(modelMatrix, Matrix4.Matrix4.IDENTITY);
                var inverseModelMatrix = Matrix4.Matrix4.inverseTransformation(modelMatrix, wrapLongitudeInversMatrix);

                var origin = Matrix4.Matrix4.multiplyByPoint(inverseModelMatrix, Cartesian3.Cartesian3.ZERO, wrapLongitudeOrigin);
                var xzNormal = Cartesian3.Cartesian3.normalize(Matrix4.Matrix4.multiplyByPointAsVector(inverseModelMatrix, Cartesian3.Cartesian3.UNIT_Y, wrapLongitudeXZNormal), wrapLongitudeXZNormal);
                var xzPlane = Plane.Plane.fromPointNormal(origin, xzNormal, wrapLongitudeXZPlane);
                var yzNormal = Cartesian3.Cartesian3.normalize(Matrix4.Matrix4.multiplyByPointAsVector(inverseModelMatrix, Cartesian3.Cartesian3.UNIT_X, wrapLongitudeYZNormal), wrapLongitudeYZNormal);
                ...
                for (var i = 1; i < length; ++i) {
                    ...
                    if (Plane.Plane.getPointDistance(yzPlane, prev) < 0.0 || Plane.Plane.getPointDistance(yzPlane, cur) < 0.0) {
                        ...
                        if (when.defined(intersection)) {
                            ...
                            var offset = Cartesian3.Cartesian3.multiplyByScalar(xzNormal, 5.0e-9, wrapLongitudeOffset);
                            if (Plane.Plane.getPointDistance(xzPlane, prev) < 0.0) {
                                Cartesian3.Cartesian3.negate(offset, offset);
                            }

                            cartesians.push(Cartesian3.Cartesian3.add(intersection, offset, new Cartesian3.Cartesian3()));
        ...
        PolylinePipeline.generateArc = function(options) {
            ...
            if (!when.defined(minDistance)) {
                ...
                minDistance = Cartesian3.CesiumMath.chordLength(granularity, ellipsoid.maximumRadius);
            }
...
//# sourceMappingURL=PolylinePipeline-5cc41d8c.js.map
