...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './BoundingSphere-bacc5cb6', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './GeometryAttributes-9d45f9e2', './GeometryOffsetAttribute-f755a5cb', './VertexFormat-a00562ee'], function (exports, when, Check, Cartesian3, BoundingSphere, ComponentDatatype, GeometryAttribute, PrimitiveType, GeometryAttributes, GeometryOffsetAttribute, VertexFormat) { 'use strict';

    var diffScratch = new Cartesian3.Cartesian3();
        ...
        function BoxGeometry(options) {
            ...
            this._minimum = Cartesian3.Cartesian3.clone(min);
            this._maximum = Cartesian3.Cartesian3.clone(max);
        ...
        BoxGeometry.fromDimensions = function(options) {
            ...
            var corner = Cartesian3.Cartesian3.multiplyByScalar(dimensions, 0.5, new Cartesian3.Cartesian3());
         ...
         * @type {Number}
         */
        BoxGeometry.packedLength = 2 * Cartesian3.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength + 1;
        ...
        BoxGeometry.pack = function(value, array, startingIndex) {
            ...
            Cartesian3.Cartesian3.pack(value._minimum, array, startingIndex);
            Cartesian3.Cartesian3.pack(value._maximum, array, startingIndex + Cartesian3.Cartesian3.packedLength);
            VertexFormat.VertexFormat.pack(value._vertexFormat, array, startingIndex + 2 * Cartesian3.Cartesian3.packedLength);
            array[startingIndex + 2 * Cartesian3.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength] = when.defaultValue(value._offsetAttribute, -1);

            return array;
        };

        var scratchMin = new Cartesian3.Cartesian3();
        var scratchMax = new Cartesian3.Cartesian3();
        ...
        BoxGeometry.unpack = function(array, startingIndex, result) {
            ...
            var min = Cartesian3.Cartesian3.unpack(array, startingIndex, scratchMin);
            var max = Cartesian3.Cartesian3.unpack(array, startingIndex + Cartesian3.Cartesian3.packedLength, scratchMax);
            var vertexFormat = VertexFormat.VertexFormat.unpack(array, startingIndex + 2 * Cartesian3.Cartesian3.packedLength, scratchVertexFormat);
            var offsetAttribute = array[startingIndex + 2 * Cartesian3.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength];
            ...
            result._minimum = Cartesian3.Cartesian3.clone(min, result._minimum);
            result._maximum = Cartesian3.Cartesian3.clone(max, result._maximum);
        ...
        BoxGeometry.createGeometry = function(boxGeometry) {
            ...
            var diff = Cartesian3.Cartesian3.subtract(max, min, diffScratch);
            var radius = Cartesian3.Cartesian3.magnitude(diff) * 0.5;
            ...
            return new GeometryAttribute.Geometry({
                ...
                boundingSphere : new BoundingSphere.BoundingSphere(Cartesian3.Cartesian3.ZERO, radius),
        ...
        BoxGeometry.getUnitBox = function() {
            if (!when.defined(unitBoxGeometry)) {
                unitBoxGeometry = BoxGeometry.createGeometry(BoxGeometry.fromDimensions({
                    dimensions : new Cartesian3.Cartesian3(1.0, 1.0, 1.0),
...
//# sourceMappingURL=BoxGeometry-d5f69a01.js.map
