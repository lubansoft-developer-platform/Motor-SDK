...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './GeometryAttributes-9d45f9e2', './IndexDatatype-e52361bd', './GeometryOffsetAttribute-f755a5cb', './VertexFormat-a00562ee'], function (exports, when, Check, Cartesian3, Cartesian2, BoundingSphere, ComponentDatatype, GeometryAttribute, PrimitiveType, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, VertexFormat) { 'use strict';
    ...
    var scratchPosition = new Cartesian3.Cartesian3();
        ...
        var scratchNormalST = new Cartesian3.Cartesian3();
        var defaultRadii = new Cartesian3.Cartesian3(1.0, 1.0, 1.0);
        ...
        function EllipsoidGeometry(options) {
            ...
            var maximumClock = when.defaultValue(options.maximumClock, Cartesian3.CesiumMath.TWO_PI);
            var minimumCone = when.defaultValue(options.minimumCone, 0.0);
            var maximumCone = when.defaultValue(options.maximumCone, Cartesian3.CesiumMath.PI);
            ...
            this._radii = Cartesian3.Cartesian3.clone(radii);
            this._innerRadii = Cartesian3.Cartesian3.clone(innerRadii);
         ...
         * @type {Number}
         */
        EllipsoidGeometry.packedLength = 2 * (Cartesian3.Cartesian3.packedLength) + VertexFormat.VertexFormat.packedLength + 7;
        ...
        EllipsoidGeometry.pack = function(value, array, startingIndex) {
            ...
            Cartesian3.Cartesian3.pack(value._innerRadii, array, startingIndex);
            startingIndex += Cartesian3.Cartesian3.packedLength;
        ...
        var scratchRadii = new Cartesian3.Cartesian3();
        var scratchInnerRadii = new Cartesian3.Cartesian3();
        ...
        EllipsoidGeometry.unpack = function(array, startingIndex, result) {
            ...
            var radii = Cartesian3.Cartesian3.unpack(array, startingIndex, scratchRadii);
            startingIndex += Cartesian3.Cartesian3.packedLength;

            var innerRadii = Cartesian3.Cartesian3.unpack(array, startingIndex, scratchInnerRadii);
            startingIndex += Cartesian3.Cartesian3.packedLength;
            ...
            result._radii = Cartesian3.Cartesian3.clone(radii, result._radii);
            result._innerRadii = Cartesian3.Cartesian3.clone(innerRadii, result._innerRadii);
        ...
        EllipsoidGeometry.createGeometry = function(ellipsoidGeometry) {
            ...
            slicePartitions = Math.round(slicePartitions * Math.abs(maximumClock - minimumClock) / Cartesian3.CesiumMath.TWO_PI);
            stackPartitions = Math.round(stackPartitions * Math.abs(maximumCone - minimumCone) / Cartesian3.CesiumMath.PI);
            ...
            if (hasInnerSurface) {
                ...
                if ((maximumClock - minimumClock) % Cartesian3.CesiumMath.TWO_PI) {
                    isClockOpen = true;
            ...
            if (vertexFormat.st || vertexFormat.normal || vertexFormat.tangent || vertexFormat.bitangent) {
                for (i = 0; i < vertexCount; i++) {
                    ...
                    var position = Cartesian3.Cartesian3.fromArray(positions, i * 3, scratchPosition);
                    ...
                    if (vertexFormat.st) {
                        ...
                        st[stIndex++] = (Math.atan2(normalST.y, normalST.x) / Cartesian3.CesiumMath.TWO_PI) + 0.5;
                    ...
                    if (vertexFormat.tangent || vertexFormat.bitangent) {
                        ...
                        if ((!isTopOpen && (i >= tangetOffset && i < (tangetOffset + numThetas * 2)))) {
                            unit = Cartesian3.Cartesian3.UNIT_X;
                        } else {
                            unit = Cartesian3.Cartesian3.UNIT_Z;
                        }
                        Cartesian3.Cartesian3.cross(unit, normal, tangent);
                        ...
                        if (vertexFormat.bitangent) {
                            var bitangent = Cartesian3.Cartesian3.cross(normal, tangent, scratchBitangent);
                            Cartesian3.Cartesian3.normalize(bitangent, bitangent);
        ...
        EllipsoidGeometry.getUnitEllipsoid = function() {
            if (!when.defined(unitEllipsoidGeometry)) {
                unitEllipsoidGeometry = EllipsoidGeometry.createGeometry((new EllipsoidGeometry({
                    radii : new Cartesian3.Cartesian3(1.0, 1.0, 1.0),
...
//# sourceMappingURL=EllipsoidGeometry-13e9bdb4.js.map
