...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab', './GeometryAttributes-9d45f9e2', './Plane-1875afb4', './VertexFormat-a00562ee'], function (exports, when, Check, Cartesian3, BoundingSphere, Matrix4, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, Plane, VertexFormat) { 'use strict';
    ...
    /**
        ...
        var faces = [new Cartesian3.Cartesian3(), new Cartesian3.Cartesian3(), new Cartesian3.Cartesian3()];
        Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.UNIT_X, faces[0]);
        Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.UNIT_Y, faces[1]);
        Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.UNIT_Z, faces[2]);

        var scratchPlaneCenter = new Cartesian3.Cartesian3();
        var scratchPlaneNormal = new Cartesian3.Cartesian3();
        var scratchPlane = new Plane.Plane(new Cartesian3.Cartesian3(1.0, 0.0, 0.0), 0.0);
        ...
        CullingVolume.fromBoundingSphere = function(boundingSphere, result) {
            ...
            for (var i = 0; i < length; ++i) {
                ...
                if (!when.defined(plane0)) {
                    plane0 = planes[planeIndex] = new Matrix4.Cartesian4();
                }
                if (!when.defined(plane1)) {
                    plane1 = planes[planeIndex + 1] = new Matrix4.Cartesian4();
                }

                Cartesian3.Cartesian3.multiplyByScalar(faceNormal, -radius, scratchPlaneCenter);
                Cartesian3.Cartesian3.add(center, scratchPlaneCenter, scratchPlaneCenter);

                plane0.x = faceNormal.x;
                plane0.y = faceNormal.y;
                plane0.z = faceNormal.z;
                plane0.w = -Cartesian3.Cartesian3.dot(faceNormal, scratchPlaneCenter);
                ...
                plane1.w = -Cartesian3.Cartesian3.dot(Cartesian3.Cartesian3.negate(faceNormal, scratchPlaneNormal), scratchPlaneCenter);
    ...
    /**
        ...
        function OrthographicOffCenterFrustum(options) {
            ...
            this._orthographicMatrix = new Matrix4.Matrix4();
        }
        ...
        function update(frustum) {
            ...
            if (frustum.top !== frustum._top || frustum.bottom !== frustum._bottom ||
                ...
                frustum._orthographicMatrix = Matrix4.Matrix4.computeOrthographicOffCenter(frustum.left, frustum.right, frustum.bottom, frustum.top, frustum.near, frustum.far, frustum._orthographicMatrix);
            }
        }
        ...
        var getPlanesRight = new Cartesian3.Cartesian3();
        var getPlanesNearCenter = new Cartesian3.Cartesian3();
        var getPlanesPoint = new Cartesian3.Cartesian3();
        var negateScratch = new Cartesian3.Cartesian3();
        ...
        OrthographicOffCenterFrustum.prototype.computeCullingVolume = function(position, direction, up) {
            ...
            var right = Cartesian3.Cartesian3.cross(direction, up, getPlanesRight);
            Cartesian3.Cartesian3.normalize(right, right);
            var nearCenter = getPlanesNearCenter;
            Cartesian3.Cartesian3.multiplyByScalar(direction, n, nearCenter);
            Cartesian3.Cartesian3.add(position, nearCenter, nearCenter);

            var point = getPlanesPoint;

            // Left plane
            Cartesian3.Cartesian3.multiplyByScalar(right, l, point);
            Cartesian3.Cartesian3.add(nearCenter, point, point);

            var plane = planes[0];
            if (!when.defined(plane)) {
                plane = planes[0] = new Matrix4.Cartesian4();
            }
            plane.x = right.x;
            plane.y = right.y;
            plane.z = right.z;
            plane.w = -Cartesian3.Cartesian3.dot(right, point);

            // Right plane
            Cartesian3.Cartesian3.multiplyByScalar(right, r, point);
            Cartesian3.Cartesian3.add(nearCenter, point, point);

            plane = planes[1];
            if (!when.defined(plane)) {
                plane = planes[1] = new Matrix4.Cartesian4();
            }
            plane.x = -right.x;
            plane.y = -right.y;
            plane.z = -right.z;
            plane.w = -Cartesian3.Cartesian3.dot(Cartesian3.Cartesian3.negate(right, negateScratch), point);

            // Bottom plane
            Cartesian3.Cartesian3.multiplyByScalar(up, b, point);
            Cartesian3.Cartesian3.add(nearCenter, point, point);

            plane = planes[2];
            if (!when.defined(plane)) {
                plane = planes[2] = new Matrix4.Cartesian4();
            }
            plane.x = up.x;
            plane.y = up.y;
            plane.z = up.z;
            plane.w = -Cartesian3.Cartesian3.dot(up, point);

            // Top plane
            Cartesian3.Cartesian3.multiplyByScalar(up, t, point);
            Cartesian3.Cartesian3.add(nearCenter, point, point);

            plane = planes[3];
            if (!when.defined(plane)) {
                plane = planes[3] = new Matrix4.Cartesian4();
            }
            plane.x = -up.x;
            plane.y = -up.y;
            plane.z = -up.z;
            plane.w = -Cartesian3.Cartesian3.dot(Cartesian3.Cartesian3.negate(up, negateScratch), point);

            // Near plane
            plane = planes[4];
            if (!when.defined(plane)) {
                plane = planes[4] = new Matrix4.Cartesian4();
            }
            plane.x = direction.x;
            plane.y = direction.y;
            plane.z = direction.z;
            plane.w = -Cartesian3.Cartesian3.dot(direction, nearCenter);

            // Far plane
            Cartesian3.Cartesian3.multiplyByScalar(direction, f, point);
            Cartesian3.Cartesian3.add(position, point, point);

            plane = planes[5];
            if (!when.defined(plane)) {
                plane = planes[5] = new Matrix4.Cartesian4();
            }
            plane.x = -direction.x;
            plane.y = -direction.y;
            plane.z = -direction.z;
            plane.w = -Cartesian3.Cartesian3.dot(Cartesian3.Cartesian3.negate(direction, negateScratch), point);
        ...
        OrthographicOffCenterFrustum.prototype.equalsEpsilon = function(other, relativeEpsilon, absoluteEpsilon) {
            return (other === this) ||
                   (when.defined(other) &&
                    ...
                    Cartesian3.CesiumMath.equalsEpsilon(this.right, other.right, relativeEpsilon, absoluteEpsilon) &&
                    Cartesian3.CesiumMath.equalsEpsilon(this.left, other.left, relativeEpsilon, absoluteEpsilon) &&
                    Cartesian3.CesiumMath.equalsEpsilon(this.top, other.top, relativeEpsilon, absoluteEpsilon) &&
                    Cartesian3.CesiumMath.equalsEpsilon(this.bottom, other.bottom, relativeEpsilon, absoluteEpsilon) &&
                    Cartesian3.CesiumMath.equalsEpsilon(this.near, other.near, relativeEpsilon, absoluteEpsilon) &&
                    Cartesian3.CesiumMath.equalsEpsilon(this.far, other.far, relativeEpsilon, absoluteEpsilon));
        };
    ...
    /**
        ...
        OrthographicFrustum.prototype.equalsEpsilon = function(other, relativeEpsilon, absoluteEpsilon) {
            ...
            return (Cartesian3.CesiumMath.equalsEpsilon(this.width, other.width, relativeEpsilon, absoluteEpsilon) &&
                    Cartesian3.CesiumMath.equalsEpsilon(this.aspectRatio, other.aspectRatio, relativeEpsilon, absoluteEpsilon) &&
    ...
    /**
        ...
        function PerspectiveOffCenterFrustum(options) {
            ...
            this._cullingVolume = new CullingVolume();
            this._perspectiveMatrix = new Matrix4.Matrix4();
            this._infinitePerspective = new Matrix4.Matrix4();
        }
        ...
        function update$2(frustum) {
            ...
            if (t !== frustum._top || b !== frustum._bottom ||
                ...
                frustum._near = n;
                frustum._far = f;
                frustum._perspectiveMatrix = Matrix4.Matrix4.computePerspectiveOffCenter(l, r, b, t, n, f, frustum._perspectiveMatrix);
                frustum._infinitePerspective = Matrix4.Matrix4.computeInfinitePerspectiveOffCenter(l, r, b, t, n, frustum._infinitePerspective);
            }
        }
        ...
        var getPlanesRight$1 = new Cartesian3.Cartesian3();
        var getPlanesNearCenter$1 = new Cartesian3.Cartesian3();
        var getPlanesFarCenter = new Cartesian3.Cartesian3();
        var getPlanesNormal = new Cartesian3.Cartesian3();
        /**
         * Creates a culling volume for this frustum.
         *
         * @param {Cartesian3} position The eye position.
        ...
        PerspectiveOffCenterFrustum.prototype.computeCullingVolume = function(position, direction, up) {
            ...
            var right = Cartesian3.Cartesian3.cross(direction, up, getPlanesRight$1);
            ...
            Cartesian3.Cartesian3.multiplyByScalar(direction, f, farCenter);
            Cartesian3.Cartesian3.add(position, farCenter, farCenter);

            var normal = getPlanesNormal;

            //Left plane computation
            Cartesian3.Cartesian3.multiplyByScalar(right, l, normal);
            Cartesian3.Cartesian3.add(nearCenter, normal, normal);
            Cartesian3.Cartesian3.subtract(normal, position, normal);
            Cartesian3.Cartesian3.normalize(normal, normal);
            Cartesian3.Cartesian3.cross(normal, up, normal);
            Cartesian3.Cartesian3.normalize(normal, normal);
            ...
            plane.y = normal.y;
            plane.z = normal.z;
            plane.w = -Cartesian3.Cartesian3.dot(normal, position);

            //Right plane computation
            Cartesian3.Cartesian3.multiplyByScalar(right, r, normal);
            Cartesian3.Cartesian3.add(nearCenter, normal, normal);
            Cartesian3.Cartesian3.subtract(normal, position, normal);
            Cartesian3.Cartesian3.cross(up, normal, normal);
            Cartesian3.Cartesian3.normalize(normal, normal);
            ...
            Cartesian3.Cartesian3.multiplyByScalar(up, b, normal);
            Cartesian3.Cartesian3.add(nearCenter, normal, normal);
            Cartesian3.Cartesian3.subtract(normal, position, normal);
            Cartesian3.Cartesian3.cross(right, normal, normal);
            Cartesian3.Cartesian3.normalize(normal, normal);
            ...
            Cartesian3.Cartesian3.multiplyByScalar(up, t, normal);
            Cartesian3.Cartesian3.add(nearCenter, normal, normal);
            Cartesian3.Cartesian3.subtract(normal, position, normal);
            Cartesian3.Cartesian3.cross(normal, right, normal);
            Cartesian3.Cartesian3.normalize(normal, normal);
            ...
            Cartesian3.Cartesian3.negate(direction, normal);
            ...
            plane.y = normal.y;
            plane.z = normal.z;
            plane.w = -Cartesian3.Cartesian3.dot(normal, farCenter);
    ...
    /**
         ...
         * @param {Number} [options.aspectRatio] The aspect ratio of the frustum's width to it's height.
         * @param {Number} [options.near=0.1] The distance of the near plane.
         * @param {Number} [options.far=500000000.0] The distance of the far plane.
        ...
        function PerspectiveFrustum(options) {
             ...
             * @default 0.1
             */
            this.near = when.defaultValue(options.near, 0.1);
            this._near = this.near;
        ...
        PerspectiveFrustum.prototype.equalsEpsilon = function(other, relativeEpsilon, absoluteEpsilon) {
            ...
            return (Cartesian3.CesiumMath.equalsEpsilon(this.fov, other.fov, relativeEpsilon, absoluteEpsilon) &&
                    Cartesian3.CesiumMath.equalsEpsilon(this.aspectRatio, other.aspectRatio, relativeEpsilon, absoluteEpsilon) &&
                    this._offCenterFrustum.equalsEpsilon(other._offCenterFrustum, relativeEpsilon, absoluteEpsilon));
        };
    ...
    var PERSPECTIVE = 0;
        ...
        function FrustumGeometry(options) {
            ...
            this._origin = Cartesian3.Cartesian3.clone(origin);
             ...
             * @type {Number}
             */
            this.packedLength = 2 + frustumPackedLength + Cartesian3.Cartesian3.packedLength + Transforms.Quaternion.packedLength + VertexFormat.VertexFormat.packedLength;
        }
        ...
        FrustumGeometry.pack = function(value, array, startingIndex) {
            ...
            Cartesian3.Cartesian3.pack(value._origin, array, startingIndex);
        ...
        var scratchPackorigin = new Cartesian3.Cartesian3();
        ...
        FrustumGeometry.unpack = function(array, startingIndex, result) {
            ...
            var origin = Cartesian3.Cartesian3.unpack(array, startingIndex, scratchPackorigin);
            startingIndex += Cartesian3.Cartesian3.packedLength;
            ...
            result._origin = Cartesian3.Cartesian3.clone(origin, result._origin);
        ...
        var scratchRotationMatrix = new Matrix4.Matrix3();
        var scratchViewMatrix = new Matrix4.Matrix4();
        var scratchInverseMatrix = new Matrix4.Matrix4();

        var scratchXDirection = new Cartesian3.Cartesian3();
        var scratchYDirection = new Cartesian3.Cartesian3();
        var scratchZDirection = new Cartesian3.Cartesian3();
        var scratchNegativeX = new Cartesian3.Cartesian3();
        var scratchNegativeY = new Cartesian3.Cartesian3();
        var scratchNegativeZ = new Cartesian3.Cartesian3();

        var frustumSplits = new Array(3);

        var frustumCornersNDC = new Array(4);
        frustumCornersNDC[0] = new Matrix4.Cartesian4(-1.0, -1.0, 1.0, 1.0);
        frustumCornersNDC[1] = new Matrix4.Cartesian4(1.0, -1.0, 1.0, 1.0);
        frustumCornersNDC[2] = new Matrix4.Cartesian4(1.0, 1.0, 1.0, 1.0);
        frustumCornersNDC[3] = new Matrix4.Cartesian4(-1.0, 1.0, 1.0, 1.0);

        var scratchFrustumCorners = new Array(4);
        for (var i = 0; i < 4; ++i) {
            scratchFrustumCorners[i] = new Matrix4.Cartesian4();
        }
        ...
        FrustumGeometry._computeNearFarPlanes = function(origin, orientation, frustumType, frustum, positions, xDirection, yDirection, zDirection) {
            var rotationMatrix = Matrix4.Matrix3.fromQuaternion(orientation, scratchRotationMatrix);
            ...
            x = Matrix4.Matrix3.getColumn(rotationMatrix, 0, x);
            y = Matrix4.Matrix3.getColumn(rotationMatrix, 1, y);
            z = Matrix4.Matrix3.getColumn(rotationMatrix, 2, z);

            Cartesian3.Cartesian3.normalize(x, x);
            Cartesian3.Cartesian3.normalize(y, y);
            Cartesian3.Cartesian3.normalize(z, z);

            Cartesian3.Cartesian3.negate(x, x);

            var view = Matrix4.Matrix4.computeView(origin, z, y, x, scratchViewMatrix);

            var inverseView;
            var inverseViewProjection;
            if (frustumType === PERSPECTIVE) {
                var projection = frustum.projectionMatrix;
                var viewProjection = Matrix4.Matrix4.multiply(projection, view, scratchInverseMatrix);
                inverseViewProjection = Matrix4.Matrix4.inverse(viewProjection, scratchInverseMatrix);
            } else {
                inverseView = Matrix4.Matrix4.inverseTransformation(view, scratchInverseMatrix);
            }
            ...
            for (var i = 0; i < 2; ++i) {
                for (var j = 0; j < 4; ++j) {
                    var corner = Matrix4.Cartesian4.clone(frustumCornersNDC[j], scratchFrustumCorners[j]);
                    ...
                    if (!when.defined(inverseViewProjection)) {
                        ...
                        Matrix4.Matrix4.multiplyByVector(inverseView, corner, corner);
                    } else {
                        corner = Matrix4.Matrix4.multiplyByVector(inverseViewProjection, corner, corner);

                        // Reverse perspective divide
                        var w = 1.0 / corner.w;
                        Cartesian3.Cartesian3.multiplyByScalar(corner, w, corner);

                        Cartesian3.Cartesian3.subtract(corner, origin, corner);
                        Cartesian3.Cartesian3.normalize(corner, corner);

                        var fac = Cartesian3.Cartesian3.dot(z, corner);
                        Cartesian3.Cartesian3.multiplyByScalar(corner, frustumSplits[i] / fac, corner);
                        Cartesian3.Cartesian3.add(corner, origin, corner);
                    }
        ...
        FrustumGeometry.createGeometry = function(frustumGeometry) {
            ...
            if (when.defined(vertexFormat.normal) || when.defined(vertexFormat.tangent) || when.defined(vertexFormat.bitangent) || when.defined(vertexFormat.st)) {
                ...
                var negativeX = Cartesian3.Cartesian3.negate(x, scratchNegativeX);
                var negativeY = Cartesian3.Cartesian3.negate(y, scratchNegativeY);
                var negativeZ = Cartesian3.Cartesian3.negate(z, scratchNegativeZ);
...
//# sourceMappingURL=FrustumGeometry-42ced641.js.map
