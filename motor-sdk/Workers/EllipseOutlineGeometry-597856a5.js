...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './GeometryAttributes-9d45f9e2', './IndexDatatype-e52361bd', './GeometryOffsetAttribute-f755a5cb', './EllipseGeometryLibrary-60c39a5b'], function (exports, when, Check, Cartesian3, Cartesian2, BoundingSphere, ComponentDatatype, GeometryAttribute, PrimitiveType, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, EllipseGeometryLibrary) { 'use strict';
    ...
    var scratchCartesian1 = new Cartesian3.Cartesian3();
        ...
        function computeExtrudedEllipse(options) {
            ...
            numberOfVerticalLines = Cartesian3.CesiumMath.clamp(numberOfVerticalLines, 0, length/2);
         ...
         * @type {Number}
         */
        EllipseOutlineGeometry.packedLength = Cartesian3.Cartesian3.packedLength + Cartesian2.Ellipsoid.packedLength + 8;
...
//# sourceMappingURL=EllipseOutlineGeometry-597856a5.js.map
