...
define(['./when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './RuntimeError-86da6af2', './Rectangle-c7d55cfa', './WebGLConstants-3660bc8f', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab', './GeometryAttributes-9d45f9e2', './IndexDatatype-e52361bd', './IntersectionTests-8855da40', './Plane-1875afb4', './VertexFormat-a00562ee', './arrayRemoveDuplicates-24a803e7', './ArcType-39be7a32', './EllipsoidRhumbLine-4bc7760a', './EllipsoidGeodesic-1d7258d7', './PolylinePipeline-5cc41d8c', './Color-cbe4364d'], function (when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, RuntimeError, Rectangle, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, IndexDatatype, IntersectionTests, Plane, VertexFormat, arrayRemoveDuplicates, ArcType, EllipsoidRhumbLine, EllipsoidGeodesic, PolylinePipeline, Color) { 'use strict';
    ...
    var scratchInterpolateColorsArray = [];
        ...
        function PolylineGeometry(options) {
             ...
             * @type {Number}
             */
            this.packedLength = numComponents + Cartesian2.Ellipsoid.packedLength + VertexFormat.VertexFormat.packedLength + 4;
        }
        ...
        var scratchPrevPosition = new Cartesian3.Cartesian3();
        var scratchNextPosition = new Cartesian3.Cartesian3();
        ...
        PolylineGeometry.createGeometry = function(polylineGeometry) {
            ...
            var positions = arrayRemoveDuplicates.arrayRemoveDuplicates(polylineGeometry._positions, Cartesian3.Cartesian3.equalsEpsilon);
            ...
            if (arcType === ArcType.ArcType.GEODESIC || arcType === ArcType.ArcType.RHUMB) {
                ...
                if (arcType === ArcType.ArcType.GEODESIC) {
                    subdivisionSize = Cartesian3.CesiumMath.chordLength(granularity, ellipsoid.maximumRadius);
            ...
            for (j = 0; j < positionsLength; ++j) {
                ...
                if (j === positionsLength - 1) {
                    position = scratchCartesian3;
                    Cartesian3.Cartesian3.subtract(positions[positionsLength - 1], positions[positionsLength - 2], position);
