...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './Transforms-7d49a8ab', './IntersectionTests-8855da40', './Plane-1875afb4'], function (exports, when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, Transforms, IntersectionTests, Plane) { 'use strict';
    ...
    /**
        ...
        function AxisAlignedBoundingBox(minimum, maximum, center) {
             ...
             */
            this.minimum = Cartesian3.Cartesian3.clone(when.defaultValue(minimum, Cartesian3.Cartesian3.ZERO));
             ...
             * @default {@link Cartesian3.ZERO}
             */
            this.maximum = Cartesian3.Cartesian3.clone(when.defaultValue(maximum, Cartesian3.Cartesian3.ZERO));

            //If center was not defined, compute it.
            if (!when.defined(center)) {
                center = Cartesian3.Cartesian3.midpoint(this.minimum, this.maximum, new Cartesian3.Cartesian3());
            } else {
                center = Cartesian3.Cartesian3.clone(center);
            }
        ...
        AxisAlignedBoundingBox.fromPoints = function(positions, result) {
            ...
            if (!when.defined(positions) || positions.length === 0) {
                result.minimum = Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.ZERO, result.minimum);
                result.maximum = Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.ZERO, result.maximum);
            ...
            result.center = Cartesian3.Cartesian3.midpoint(minimum, maximum, result.center);
        ...
        AxisAlignedBoundingBox.clone = function(box, result) {
            ...
            result.minimum = Cartesian3.Cartesian3.clone(box.minimum, result.minimum);
            result.maximum = Cartesian3.Cartesian3.clone(box.maximum, result.maximum);
            result.center = Cartesian3.Cartesian3.clone(box.center, result.center);
            return result;
        };
        ...
        AxisAlignedBoundingBox.equals = function(left, right) {
            return (left === right) ||
                   ((when.defined(left)) &&
                    ...
                    Cartesian3.Cartesian3.equals(left.minimum, right.minimum) &&
                    Cartesian3.Cartesian3.equals(left.maximum, right.maximum));
        };

        var intersectScratch = new Cartesian3.Cartesian3();
        /**
        ...
        AxisAlignedBoundingBox.intersectPlane = function(box, plane) {
            ...
            intersectScratch = Cartesian3.Cartesian3.subtract(box.maximum, box.minimum, intersectScratch);
            var h = Cartesian3.Cartesian3.multiplyByScalar(intersectScratch, 0.5, intersectScratch); //The positive half diagonal
            var normal = plane.normal;
            var e = h.x * Math.abs(normal.x) + h.y * Math.abs(normal.y) + h.z * Math.abs(normal.z);
            var s = Cartesian3.Cartesian3.dot(box.center, normal) + plane.distance; //signed distance from center
        ...
        AxisAlignedBoundingBox.prototype.transformBy = function(matrix) {
            ...
            vertices.forEach((vertex) => {
                Matrix4.Matrix4.multiplyByPoint(matrix, vertex, vertex);
            });
            ...
            for (let i = 0; i < 2; ++i) {
                for (let j = 0; j < 2; ++j) {
                    for (let k = 0; k < 2; ++k) {
                        ...
                        const vertex = new Cartesian3.Cartesian3(x, y, z);
        ...
        AxisAlignedBoundingBox.fromBoundingSphere = function(center, radius){
            let minimum = new Cartesian3.Cartesian3(center.x - radius, center.y - radius, center.z - radius);
            let maximum = new Cartesian3.Cartesian3(center.x + radius, center.y + radius, center.z + radius);
            return new AxisAlignedBoundingBox(minimum, maximum);
        };

    var scratchCart4 = new Matrix4.Cartesian4();
        /**
        ...
        function EllipsoidTangentPlane(origin, ellipsoid) {
            ...
            this._origin = origin;
            this._xAxis = Cartesian3.Cartesian3.fromCartesian4(Matrix4.Matrix4.getColumn(eastNorthUp, 0, scratchCart4));
            this._yAxis = Cartesian3.Cartesian3.fromCartesian4(Matrix4.Matrix4.getColumn(eastNorthUp, 1, scratchCart4));

            var normal = Cartesian3.Cartesian3.fromCartesian4(Matrix4.Matrix4.getColumn(eastNorthUp, 2, scratchCart4));
        ...
        var scratchProjectPointOntoPlaneCartesian3 = new Cartesian3.Cartesian3();
        ...
        EllipsoidTangentPlane.prototype.projectPointOntoPlane = function(cartesian, result) {
            ...
            if (when.defined(intersectionPoint)) {
                var v = Cartesian3.Cartesian3.subtract(intersectionPoint, this._origin, intersectionPoint);
                var x = Cartesian3.Cartesian3.dot(this._xAxis, v);
                var y = Cartesian3.Cartesian3.dot(this._yAxis, v);
        ...
        var projectPointsOntoEllipsoidScratch = new Cartesian3.Cartesian3();
        /**
...
//# sourceMappingURL=EllipsoidTangentPlane-680fe82b.js.map
