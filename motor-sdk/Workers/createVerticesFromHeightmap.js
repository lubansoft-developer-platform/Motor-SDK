...
define(['./when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './RuntimeError-86da6af2', './Rectangle-c7d55cfa', './WebGLConstants-3660bc8f', './ComponentDatatype-86703c58', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab', './AttributeCompression-1e177d5e', './IndexDatatype-e52361bd', './IntersectionTests-8855da40', './Plane-1875afb4', './WebMercatorProjection-c32b7757', './createTaskProcessorWorker', './EllipsoidTangentPlane-3e14dd4d', './OrientedBoundingBox-c5c382aa', './CreatePhysicalArray-d462d0a0', './materem-f017d2c3', './TerrainEncoding-eef38e10', './TerrainProvider-00be0263'], function (when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, RuntimeError, Rectangle, WebGLConstants, ComponentDatatype, PrimitiveType, Transforms, AttributeCompression, IndexDatatype, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, CreatePhysicalArray, materem, TerrainEncoding, TerrainProvider) { 'use strict';
    ...
    /**
        ...
        HeightmapTessellator.computeVertices = function(options) {
            ...
            var atan = Math.atan;
            var exp = Math.exp;
            var piOverTwo = Cartesian3.CesiumMath.PI_OVER_TWO;
            var toRadians = Cartesian3.CesiumMath.toRadians;
            ...
            var rectangleWidth = Rectangle.Rectangle.computeWidth(nativeRectangle);
            var rectangleHeight = Rectangle.Rectangle.computeHeight(nativeRectangle);
            ...
            for (var rowIndex = startRow; rowIndex < endRow; ++rowIndex) {
                ...
                for (var colIndex = startCol; colIndex < endCol; ++colIndex) {
                    ...
                    var position = new Cartesian3.Cartesian3();
    ...
    */
    ...
    function createVertices(parameters, transferableObjects) {
        ...
        if (parameters.skirtHeight > 0.0) {
            indicesAndEdges = TerrainProvider.TerrainProvider.getRegularGridAndSkirtIndicesAndEdgeIndices(parameters.width, parameters.height);
        } else {
            indicesAndEdges = TerrainProvider.TerrainProvider.getRegularGridIndicesAndEdgeIndices(parameters.width, parameters.height);
        }
        var physicalArray = CreatePhysicalArray.CreatePhysicalArray.createPhysicalArrayFromTerrain(physical, lbSpaMgr, parameters.relativeToCenter, statistics.positions, indicesAndEdges.indices);
        transferableObjects.push(vertices.buffer, physicalArray.buffer);
    ...
    function createVerticesFromHeightmap(event) {
        var data = event.data;
