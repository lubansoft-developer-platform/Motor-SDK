...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a'], function (exports, when, Check, Cartesian3, Cartesian2) { 'use strict';
    ...
    /**
        ...
        Rectangle.southwest = function(rectangle, result) {
            ...
            if (!when.defined(result)) {
                return new Cartesian2.Cartographic(rectangle.west, rectangle.south);
            }
        ...
        Rectangle.northwest = function(rectangle, result) {
            ...
            if (!when.defined(result)) {
                return new Cartesian2.Cartographic(rectangle.west, rectangle.north);
            }
            result.longitude = rectangle.west;
        ...
        Rectangle.northeast = function(rectangle, result) {
            ...
            if (!when.defined(result)) {
                return new Cartesian2.Cartographic(rectangle.east, rectangle.north);
            }
        ...
        Rectangle.southeast = function(rectangle, result) {
            ...
            if (!when.defined(result)) {
                return new Cartesian2.Cartographic(rectangle.east, rectangle.south);
            }
            result.longitude = rectangle.east;
            result.latitude = rectangle.south;
            result.height = 0.0;
        ...
        Rectangle.center = function(rectangle, result) {
            ...
            if (!when.defined(result)) {
                return new Cartesian2.Cartographic(longitude, latitude);
            }
        ...
        var subsampleLlaScratch = new Cartesian2.Cartographic();
        /**
...
//# sourceMappingURL=Rectangle-c7d55cfa.js.map
