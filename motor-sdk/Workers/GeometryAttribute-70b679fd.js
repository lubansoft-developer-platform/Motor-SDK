...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './Matrix4-c65e6a1b', './Rectangle-c7d55cfa', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab'], function (exports, when, Check, Cartesian3, Cartesian2, Matrix4, Rectangle, PrimitiveType, Transforms) { 'use strict';
    ...
    /**
        ...
        var enuCenterScratch = new Cartesian3.Cartesian3();
        var fixedFrameToEnuScratch = new Matrix4.Matrix4();
        ...
        var pointEnuScratch = new Cartesian3.Cartesian3();
        var enuRotationScratch = new Transforms.Quaternion();
        var enuRotationMatrixScratch = new Matrix4.Matrix4();
        ...
        Geometry._textureCoordinateRotationPoints = function(positions, stRotation, ellipsoid, boundingRectangle) {
            ...
            var rectangleCenter = Rectangle.Rectangle.center(boundingRectangle, rectangleCenterScratch);
            ...
            var fixedFrameToEnu = Matrix4.Matrix4.inverse(enuToFixedFrame, fixedFrameToEnuScratch);
            ...
            for (i = 0; i < 3; i++) {
                ...
                posEnu = Matrix4.Matrix4.multiplyByPointAsVector(fixedFrameToEnu, posEnu, posEnu);
            ...
            var rotation = Transforms.Quaternion.fromAxisAngle(Cartesian3.Cartesian3.UNIT_Z, -stRotation, enuRotationScratch);
            var textureMatrix = Matrix4.Matrix3.fromQuaternion(rotation, enuRotationMatrixScratch);
            ...
            for (i = 0; i < positionsLength; i++) {
                posEnu = Matrix4.Matrix4.multiplyByPointAsVector(fixedFrameToEnu, positions[i], posEnu);
                posEnu = Matrix4.Matrix3.multiplyByVector(textureMatrix, posEnu, posEnu);
...
//# sourceMappingURL=GeometryAttribute-70b679fd.js.map
