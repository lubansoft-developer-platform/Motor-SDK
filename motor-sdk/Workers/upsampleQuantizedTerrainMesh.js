...
define(['./when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './RuntimeError-86da6af2', './Rectangle-c7d55cfa', './WebGLConstants-3660bc8f', './ComponentDatatype-86703c58', './Transforms-7d49a8ab', './AttributeCompression-1e177d5e', './IndexDatatype-e52361bd', './IntersectionTests-8855da40', './Plane-1875afb4', './createTaskProcessorWorker', './EllipsoidTangentPlane-3e14dd4d', './OrientedBoundingBox-c5c382aa', './materem-f017d2c3', './EmWrapperManager-a482472d', './TerrainEncoding-eef38e10', './EmLBDeal-8c054e74'], function (when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, RuntimeError, Rectangle, WebGLConstants, ComponentDatatype, Transforms, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, materem, EmWrapperManager, TerrainEncoding, EmLBDeal) { 'use strict';
    ...
    /**
        ...
        Intersections2D.computeBarycentricCoordinates = function(x, y, x1, y1, x2, y2, x3, y3, result) {
            ...
            return new Cartesian3.Cartesian3(l1, l2, l3);
        };
    ...
    var maxShort = 32767;
        ...
        var indicesScratch = [];
        var normalsScratch = [];
        var horizonOcclusionPointScratch = new Cartesian3.Cartesian3();
        ...
        var octEncodedNormalScratch = new Cartesian3.Cartesian3();
        ...
        function createSplitVertices(parameters, transferableObjects) {
            ...
            for (i = 0, n = 0; i < quantizedVertexCount; ++i, n += 2) {
                ...
                u = Cartesian3.CesiumMath.clamp((texCoords.x * maxShort) | 0, 0, maxShort);
                v = Cartesian3.CesiumMath.clamp((texCoords.y * maxShort) | 0, 0, maxShort);
                parentHeightBuffer[i] = Cartesian3.CesiumMath.clamp((((height - parentMinimumHeight) / (parentMaximumHeight - parentMinimumHeight)) * maxShort) | 0, 0, maxShort);
            ...
            var rectangle = Rectangle.Rectangle.clone(parameters.childRectangle);
            ...
            for (i = 0; i < uBuffer.length; ++i) {
                ...
                height = Cartesian3.CesiumMath.lerp(parentMinimumHeight, parentMaximumHeight, heightBuffer[i] / maxShort);
                ...
                cartographicScratch.longitude = Cartesian3.CesiumMath.lerp(west, east, u / maxShort);
                cartographicScratch.latitude = Cartesian3.CesiumMath.lerp(south, north, v / maxShort);
                cartographicScratch.height = height;

                ellipsoid.cartographicToCartesian(cartographicScratch, cartesian3Scratch);

                if (when.defined(emLBDeal)) {
                    emLBDeal.computeCartesianToProj(cartesian3Scratch, undefined, cartesian3Scratch);
                }
            ...
            var boundingSphere = BoundingSphere.BoundingSphere.fromVertices(cartesianVertices, Cartesian3.Cartesian3.ZERO, 3, boundingSphereScratch);
            var orientedBoundingBox;
            var horizonOcclusionPoint;
            if (when.defined(emLBDeal)) {
                orientedBoundingBox = OrientedBoundingBox.OrientedBoundingBox.fromPoints(boundingSphere.getCornerAry());
                horizonOcclusionPoint = new Cartesian3.Cartesian3();
            } else {
                orientedBoundingBox = OrientedBoundingBox.OrientedBoundingBox.fromRectangle(rectangle, minimumHeight, maximumHeight, ellipsoid, orientedBoundingBoxScratch);
        ...
        Vertex.prototype.getH = function() {
            ...
            return Cartesian3.CesiumMath.lerp(this.first.getH(), this.second.getH(), this.ratio);
        };
        ...
        Vertex.prototype.getU = function() {
            ...
            return Cartesian3.CesiumMath.lerp(this.first.getU(), this.second.getU(), this.ratio);
        };
        ...
        Vertex.prototype.getV = function() {
            ...
            return Cartesian3.CesiumMath.lerp(this.first.getV(), this.second.getV(), this.ratio);
        };
        ...
        var depth = -1;
        var cartesianScratch1 = [new Cartesian3.Cartesian3(), new Cartesian3.Cartesian3()];
        var cartesianScratch2 = [new Cartesian3.Cartesian3(), new Cartesian3.Cartesian3()];
        function lerpOctEncodedNormal(vertex, result) {
            ...
            cartesian3Scratch = Cartesian3.Cartesian3.lerp(first, second, vertex.ratio, cartesian3Scratch);
            Cartesian3.Cartesian3.normalize(cartesian3Scratch, cartesian3Scratch);
