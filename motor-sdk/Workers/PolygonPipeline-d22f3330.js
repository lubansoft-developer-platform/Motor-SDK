...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './WebGLConstants-3660bc8f', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './EllipsoidRhumbLine-4bc7760a'], function (exports, when, Check, Cartesian3, Cartesian2, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, EllipsoidRhumbLine) { 'use strict';
    ...
    var scaleToGeodeticHeightN = new Cartesian3.Cartesian3();
        var scaleToGeodeticHeightP = new Cartesian3.Cartesian3();
        ...
        var subdivisionV0Scratch = new Cartesian3.Cartesian3();
        var subdivisionV1Scratch = new Cartesian3.Cartesian3();
        var subdivisionV2Scratch = new Cartesian3.Cartesian3();
        var subdivisionS0Scratch = new Cartesian3.Cartesian3();
        var subdivisionS1Scratch = new Cartesian3.Cartesian3();
        var subdivisionS2Scratch = new Cartesian3.Cartesian3();
        var subdivisionMidScratch = new Cartesian3.Cartesian3();
        ...
        PolygonPipeline.computeSubdivision = function(ellipsoid, positions, indices, granularity) {
            granularity = when.defaultValue(granularity, Cartesian3.CesiumMath.RADIANS_PER_DEGREE);
            ...
            var minDistance = Cartesian3.CesiumMath.chordLength(granularity, radius);
            ...
            while (triangles.length > 0) {
                ...
                var v0 = Cartesian3.Cartesian3.fromArray(subdividedPositions, i0 * 3, subdivisionV0Scratch);
                var v1 = Cartesian3.Cartesian3.fromArray(subdividedPositions, i1 * 3, subdivisionV1Scratch);
                var v2 = Cartesian3.Cartesian3.fromArray(subdividedPositions, i2 * 3, subdivisionV2Scratch);

                var s0 = Cartesian3.Cartesian3.multiplyByScalar(Cartesian3.Cartesian3.normalize(v0, subdivisionS0Scratch), radius, subdivisionS0Scratch);
                var s1 = Cartesian3.Cartesian3.multiplyByScalar(Cartesian3.Cartesian3.normalize(v1, subdivisionS1Scratch), radius, subdivisionS1Scratch);
                var s2 = Cartesian3.Cartesian3.multiplyByScalar(Cartesian3.Cartesian3.normalize(v2, subdivisionS2Scratch), radius, subdivisionS2Scratch);

                var g0 = Cartesian3.Cartesian3.magnitudeSquared(Cartesian3.Cartesian3.subtract(s0, s1, subdivisionMidScratch));
                var g1 = Cartesian3.Cartesian3.magnitudeSquared(Cartesian3.Cartesian3.subtract(s1, s2, subdivisionMidScratch));
                var g2 = Cartesian3.Cartesian3.magnitudeSquared(Cartesian3.Cartesian3.subtract(s2, s0, subdivisionMidScratch));
                ...
                if (max > minDistanceSqrd) {
                    if (g0 === max) {
                        ...
                        i = edges[edge];
                        if (!when.defined(i)) {
                            mid = Cartesian3.Cartesian3.add(v0, v1, subdivisionMidScratch);
                            Cartesian3.Cartesian3.multiplyByScalar(mid, 0.5, mid);
                        ...
                        i = edges[edge];
                        if (!when.defined(i)) {
                            mid = Cartesian3.Cartesian3.add(v1, v2, subdivisionMidScratch);
                            Cartesian3.Cartesian3.multiplyByScalar(mid, 0.5, mid);
                            subdividedPositions.push(mid.x, mid.y, mid.z);
                            i = subdividedPositions.length / 3 - 1;
                            edges[edge] = i;
                        ...
                        i = edges[edge];
                        if (!when.defined(i)) {
                            mid = Cartesian3.Cartesian3.add(v2, v0, subdivisionMidScratch);
                            Cartesian3.Cartesian3.multiplyByScalar(mid, 0.5, mid);
                            subdividedPositions.push(mid.x, mid.y, mid.z);
                            i = subdividedPositions.length / 3 - 1;
                            edges[edge] = i;
                ...
                if (max > minDistance) {
                    if (g0 === max) {
                        ...
                        if (!when.defined(i)) {
                            ...
                            midCartesian3 = Cartesian3.Cartesian3.fromRadians(mid.longitude, mid.latitude, midHeight, ellipsoid, subdivisionMidScratch);
        ...
        PolygonPipeline.scaleToGeodeticHeight = function(positions, height, ellipsoid, scaleToSurface) {
            ...
            if (when.defined(positions)) {
                ...
                for ( var i = 0; i < length; i += 3) {
                    Cartesian3.Cartesian3.fromArray(positions, i, p);
...
//# sourceMappingURL=PolygonPipeline-d22f3330.js.map
