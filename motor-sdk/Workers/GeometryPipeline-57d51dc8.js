...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './AttributeCompression-1e177d5e', './EncodedCartesian3-7b803d4a', './IndexDatatype-e52361bd', './IntersectionTests-8855da40', './Plane-1875afb4'], function (exports, when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, ComponentDatatype, GeometryAttribute, PrimitiveType, AttributeCompression, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane) { 'use strict';
    ...
    var scratchCartesian1 = new Cartesian3.Cartesian3();
        ...
        function barycentricCoordinates(point, p0, p1, p2, result) {
            ...
            if(!when.defined(p0.z)) {
                if (Cartesian2.Cartesian2.equalsEpsilon(point, p0, Cartesian3.CesiumMath.EPSILON14)) {
                    return Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.UNIT_X, result);
                }
                if (Cartesian2.Cartesian2.equalsEpsilon(point, p1, Cartesian3.CesiumMath.EPSILON14)) {
                    return Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.UNIT_Y, result);
                }
                if (Cartesian2.Cartesian2.equalsEpsilon(point, p2, Cartesian3.CesiumMath.EPSILON14)) {
                ...
                if (Cartesian3.Cartesian3.equalsEpsilon(point, p0, Cartesian3.CesiumMath.EPSILON14)) {
                    return Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.UNIT_X, result);
                }
                if (Cartesian3.Cartesian3.equalsEpsilon(point, p1, Cartesian3.CesiumMath.EPSILON14)) {
                    return Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.UNIT_Y, result);
                }
                if (Cartesian3.Cartesian3.equalsEpsilon(point, p2, Cartesian3.CesiumMath.EPSILON14)) {
                    return Cartesian3.Cartesian3.clone(Cartesian3.Cartesian3.UNIT_Z, result);
                }

                v0 = Cartesian3.Cartesian3.subtract(p1, p0, scratchCartesian1);
                v1 = Cartesian3.Cartesian3.subtract(p2, p0, scratchCartesian2);
                v2 = Cartesian3.Cartesian3.subtract(point, p0, scratchCartesian3);
    ...
    /**
        ...
        GeometryPipeline.fitToUnsignedShortIndices = function(geometry) {
            ...
            if (when.defined(geometry.indices) && (numberOfVertices >= Cartesian3.CesiumMath.SIXTY_FOUR_KILOBYTES)) {
                var oldToNewIndex = [];
                var newIndices = [];
                var currentIndex = 0;
                ...
                for ( var j = 0; j < numberOfIndices; j += indicesPerPrimitive) {
                    ...
                    if (currentIndex + indicesPerPrimitive >= Cartesian3.CesiumMath.SIXTY_FOUR_KILOBYTES) {
        ...
        var scratchProjectTo2DCartesian3 = new Cartesian3.Cartesian3();
        ...
        GeometryPipeline.projectTo2D = function(geometry, attributeName, attributeName3D, attributeName2D, projection) {
            ...
            for ( var i = 0; i < values3D.length; i += 3) {
                var value = Cartesian3.Cartesian3.fromArray(values3D, i, scratchProjectTo2DCartesian3);
        ...
        var scratchCartesian3$1 = new Cartesian3.Cartesian3();
        ...
        function transformPoint(matrix, attribute) {
            if (when.defined(attribute)) {
                ...
                for (var i = 0; i < length; i += 3) {
                    Cartesian3.Cartesian3.unpack(values, i, scratchCartesian3$1);
                    Matrix4.Matrix4.multiplyByPoint(matrix, scratchCartesian3$1, scratchCartesian3$1);
                    Cartesian3.Cartesian3.pack(scratchCartesian3$1, values, i);
                }
            }
        }
        ...
        function transformVector(matrix, attribute) {
            if (when.defined(attribute)) {
                ...
                for (var i = 0; i < length; i += 3) {
                    Cartesian3.Cartesian3.unpack(values, i, scratchCartesian3$1);
                    Matrix4.Matrix3.multiplyByVector(matrix, scratchCartesian3$1, scratchCartesian3$1);
                    scratchCartesian3$1 = Cartesian3.Cartesian3.normalize(scratchCartesian3$1, scratchCartesian3$1);
                    Cartesian3.Cartesian3.pack(scratchCartesian3$1, values, i);
                }
            }
        }

        var inverseTranspose = new Matrix4.Matrix4();
        var normalMatrix = new Matrix4.Matrix3();
        ...
        GeometryPipeline.transformToWorldCoordinates = function(instance) {
            ...
            if (Matrix4.Matrix4.equals(modelMatrix, Matrix4.Matrix4.IDENTITY)) {
            ...
            if ((when.defined(attributes.normal)) ||
                ...
                Matrix4.Matrix4.inverse(modelMatrix, inverseTranspose);
                Matrix4.Matrix4.transpose(inverseTranspose, inverseTranspose);
                Matrix4.Matrix4.getMatrix3(inverseTranspose, normalMatrix);
            ...
            instance.modelMatrix = Matrix4.Matrix4.clone(Matrix4.Matrix4.IDENTITY);
        ...
        var tempScratch = new Cartesian3.Cartesian3();
        ...
        function combineGeometries(instances, propertyName) {
            ...
            //>>includeStart('debug', pragmas.debug);
            for (i = 1; i < length; ++i) {
                if (!Matrix4.Matrix4.equals(instances[i].modelMatrix, m)) {
            ...
            var center = new Cartesian3.Cartesian3();
            var radius = 0.0;
            var bs;
            ...
            if (when.defined(center)) {
                ...
                for (i = 0; i < length; ++i) {
                    bs = instances[i][propertyName].boundingSphere;
                    var tempRadius = Cartesian3.Cartesian3.magnitude(Cartesian3.Cartesian3.subtract(bs.center, center, tempScratch)) + bs.radius;
        ...
        var normal = new Cartesian3.Cartesian3();
        var v0 = new Cartesian3.Cartesian3();
        var v1 = new Cartesian3.Cartesian3();
        var v2 = new Cartesian3.Cartesian3();
            ...
            for (i = 0; i < numVertices; i++) {
                ...
                if (vertexNormalData.count > 0) {
                    for (j = 0; j < vertexNormalData.count; j++) {
                        Cartesian3.Cartesian3.add(normal, normalsPerTriangle[normalIndices[vertexNormalData.indexOffset + j]], normal);
                    }

                    // We can run into an issue where a vertex is used with 2 primitives that have opposite winding order.
                    if (Cartesian3.Cartesian3.equalsEpsilon(Cartesian3.Cartesian3.ZERO, normal, Cartesian3.CesiumMath.EPSILON10)) {
                        Cartesian3.Cartesian3.clone(normalsPerTriangle[normalIndices[vertexNormalData.indexOffset]], normal);
                    }
                }
        ...
        var normalScratch = new Cartesian3.Cartesian3();
        var normalScale = new Cartesian3.Cartesian3();
        var tScratch = new Cartesian3.Cartesian3();
        ...
        GeometryPipeline.computeTangentAndBitangent = function(geometry) {
            ...
            for (i = 0; i < numVertices; i++) {
                ...
                var n = Cartesian3.Cartesian3.fromArray(normals, i03, normalScratch);
                var t = Cartesian3.Cartesian3.fromArray(tan1, i03, tScratch);
                var scalar = Cartesian3.Cartesian3.dot(n, t);
        ...
        var toEncode1 = new Cartesian3.Cartesian3();
        var toEncode2 = new Cartesian3.Cartesian3();
        var toEncode3 = new Cartesian3.Cartesian3();
        ...
        function offsetPointFromXZPlane(p, isBehind) {
            if (Math.abs(p.y) < Cartesian3.CesiumMath.EPSILON6){
                if (isBehind) {
                    p.y = -Cartesian3.CesiumMath.EPSILON6;
                } else {
                    p.y = Cartesian3.CesiumMath.EPSILON6;
                }
            }
        ...
        function offsetTriangleFromXZPlane(p0, p1, p2) {
            ...
            if (p0y > p1y) {
                if (p0y > p2y) {
                    sign = Cartesian3.CesiumMath.sign(p0.y);
                } else {
                    sign = Cartesian3.CesiumMath.sign(p2.y);
                }
            } else if (p1y > p2y) {
                sign = Cartesian3.CesiumMath.sign(p1.y);
            } else {
                sign = Cartesian3.CesiumMath.sign(p2.y);
            }
        ...
        var c3 = new Cartesian3.Cartesian3();
        function getXZIntersectionOffsetPoints(p, p1, u1, v1) {
            Cartesian3.Cartesian3.add(p, Cartesian3.Cartesian3.multiplyByScalar(Cartesian3.Cartesian3.subtract(p1, p, c3), p.y/(p.y-p1.y), c3), u1);
            Cartesian3.Cartesian3.clone(u1, v1);
            offsetPointFromXZPlane(u1, true);
            offsetPointFromXZPlane(v1, false);
        }

        var u1 = new Cartesian3.Cartesian3();
        var u2 = new Cartesian3.Cartesian3();
        var q1 = new Cartesian3.Cartesian3();
        var q2 = new Cartesian3.Cartesian3();
        ...
        var interpolateAndPackCartesian4 = generateBarycentricInterpolateFunction(Matrix4.Cartesian4, 4);
        var interpolateAndPackCartesian3 = generateBarycentricInterpolateFunction(Cartesian3.Cartesian3, 3);
        ...
        var interpolateAndPackBoolean = function(i0, i1, i2, coords, sourceValues, currentValues, insertedIndex) {
            ...
            currentValues[insertedIndex] = (v1 + v2 + v3) > Cartesian3.CesiumMath.EPSILON6 ? 1 : 0;
        };

        var p0Scratch = new Cartesian3.Cartesian3();
        var p1Scratch = new Cartesian3.Cartesian3();
        var p2Scratch = new Cartesian3.Cartesian3();
        var barycentricScratch = new Cartesian3.Cartesian3();
        ...
        function computeTriangleAttributes(i0, i1, i2, point, positions, normals, tangents, bitangents, texCoords, extrudeDirections, applyOffset, currentAttributes, customAttributeNames, customAttributesLength, allAttributes, insertedIndex) {
            ...
            var p0 = Cartesian3.Cartesian3.fromArray(positions, i0 * 3, p0Scratch);
            var p1 = Cartesian3.Cartesian3.fromArray(positions, i1 * 3, p1Scratch);
            var p2 = Cartesian3.Cartesian3.fromArray(positions, i2 * 3, p2Scratch);
            ...
            if (when.defined(extrudeDirections)) {
                var d0 = Cartesian3.Cartesian3.fromArray(extrudeDirections, i0 * 3, p0Scratch);
                var d1 = Cartesian3.Cartesian3.fromArray(extrudeDirections, i1 * 3, p1Scratch);
                var d2 = Cartesian3.Cartesian3.fromArray(extrudeDirections, i2 * 3, p2Scratch);
                ...
                var direction;
                if (!Cartesian3.Cartesian3.equals(d0, Cartesian3.Cartesian3.ZERO) || !Cartesian3.Cartesian3.equals(d1, Cartesian3.Cartesian3.ZERO) || !Cartesian3.Cartesian3.equals(d2, Cartesian3.Cartesian3.ZERO)) {
                ...
                Cartesian3.Cartesian3.pack(direction, currentAttributes.extrudeDirection.values, insertedIndex * 3);
            }
        ...
        function splitLongitudeTriangles(instance) {
            ...
            for (i = 0; i < len; i += 3) {
                ...
                var p0 = Cartesian3.Cartesian3.fromArray(positions, i0 * 3);
                var p1 = Cartesian3.Cartesian3.fromArray(positions, i1 * 3);
                var p2 = Cartesian3.Cartesian3.fromArray(positions, i2 * 3);
        ...
        var xzPlane = Plane.Plane.fromPointNormal(Cartesian3.Cartesian3.ZERO, Cartesian3.Cartesian3.UNIT_Y);

        var offsetScratch = new Cartesian3.Cartesian3();
        var offsetPointScratch = new Cartesian3.Cartesian3();
        ...
        function computeLineAttributes(i0, i1, point, positions, insertIndex, currentAttributes, applyOffset) {
            ...
            var p0 = Cartesian3.Cartesian3.fromArray(positions, i0 * 3, p0Scratch);
            if (Cartesian3.Cartesian3.equalsEpsilon(p0, point, Cartesian3.CesiumMath.EPSILON10)) {
        ...
        function splitLongitudeLines(instance) {
            ...
            for (i = 0; i < length; i += 2) {
                ...
                if (Math.abs(p0.y) < Cartesian3.CesiumMath.EPSILON6){
                    if (p0.y < 0.0) {
                        p0.y = -Cartesian3.CesiumMath.EPSILON6;
                    } else {
                        p0.y = Cartesian3.CesiumMath.EPSILON6;
                    }
                }

                if (Math.abs(p1.y) < Cartesian3.CesiumMath.EPSILON6){
                    if (p1.y < 0.0) {
                        p1.y = -Cartesian3.CesiumMath.EPSILON6;
                    } else {
                        p1.y = Cartesian3.CesiumMath.EPSILON6;
                    }
                }
                ...
                if (when.defined(intersection)) {
                    ...
                    var offset = Cartesian3.Cartesian3.multiplyByScalar(Cartesian3.Cartesian3.UNIT_Y, 5.0 * Cartesian3.CesiumMath.EPSILON9, offsetScratch);
                    if (p0.y < 0.0) {
                    ...
                    var offsetPoint = Cartesian3.Cartesian3.add(intersection, offset, offsetPointScratch);
        ...
        var cartesian3Scratch0 = new Cartesian3.Cartesian3();
        var cartesian3Scratch2 = new Cartesian3.Cartesian3();
        var cartesian3Scratch3 = new Cartesian3.Cartesian3();
        var cartesian3Scratch4 = new Cartesian3.Cartesian3();
        var cartesian3Scratch5 = new Cartesian3.Cartesian3();
        var cartesian3Scratch6 = new Cartesian3.Cartesian3();

        var cartesian4Scratch0 = new Matrix4.Cartesian4();
        ...
        function updateAdjacencyAfterSplit(geometry) {
            ...
            for (var j = 0; j < length; j += 3) {
                var position = Cartesian3.Cartesian3.unpack(positions, j, cartesian3Scratch0);
                if (position.x > 0.0) {
                    continue;
                }

                var prevPosition = Cartesian3.Cartesian3.unpack(prevPositions, j, cartesian3Scratch2);
                ...
                var nextPosition = Cartesian3.Cartesian3.unpack(nextPositions, j, cartesian3Scratch3);
        ...
        var offsetScalar = 5.0 * Cartesian3.CesiumMath.EPSILON9;
        var coplanarOffset = Cartesian3.CesiumMath.EPSILON6;
        ...
        function splitLongitudePolyline(instance) {
            ...
            for (i = 0; i < length; i += 4) {
                ...
                var p0 = Cartesian3.Cartesian3.fromArray(positions, i0 * 3, cartesian3Scratch0);
                var p2 = Cartesian3.Cartesian3.fromArray(positions, i2 * 3, cartesian3Scratch2);
                ...
                if (when.defined(intersection)) {
                    ...
                    // move point on the xz-plane slightly away from the plane
                    var offset = Cartesian3.Cartesian3.multiplyByScalar(Cartesian3.Cartesian3.UNIT_Y, offsetScalar, cartesian3Scratch5);
                    if (p0.y < 0.0) {
                        Cartesian3.Cartesian3.negate(offset, offset);
                        p0Attributes = westGeometry.attributes;
                        p0Indices = westGeometry.indices;
                    ...
                    var offsetPoint = Cartesian3.Cartesian3.add(intersection, offset, cartesian3Scratch6);
                    ...
                    var t = Cartesian3.Cartesian3.magnitudeSquared(Cartesian3.Cartesian3.subtract(intersection, p0, cartesian3Scratch3));
                    t /= Cartesian3.Cartesian3.magnitudeSquared(Cartesian3.Cartesian3.subtract(p2, p0, cartesian3Scratch3));

                    if (when.defined(colors)) {
                        var c0 = Matrix4.Cartesian4.fromArray(colors, i0 * 4, cartesian4Scratch0);
                        var c2 = Matrix4.Cartesian4.fromArray(colors, i2 * 4, cartesian4Scratch0);

                        var r = Cartesian3.CesiumMath.lerp(c0.x, c2.x, t);
                        var g = Cartesian3.CesiumMath.lerp(c0.y, c2.y, t);
                        var b = Cartesian3.CesiumMath.lerp(c0.z, c2.z, t);
                        var a = Cartesian3.CesiumMath.lerp(c0.w, c2.w, t);
                    ...
                    if (when.defined(texCoords)) {
                        ...
                        var sx = Cartesian3.CesiumMath.lerp(s0.x, s3.x, t);
...
//# sourceMappingURL=GeometryPipeline-57d51dc8.js.map
