...
define(['./when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './RuntimeError-86da6af2', './Rectangle-c7d55cfa', './WebGLConstants-3660bc8f', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab', './GeometryAttributes-9d45f9e2', './GeometryOffsetAttribute-f755a5cb'], function (when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, RuntimeError, Rectangle, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, GeometryOffsetAttribute) { 'use strict';
    ...
    var diffScratch = new Cartesian3.Cartesian3();
        ...
        BoxOutlineGeometry.pack = function(value, array, startingIndex) {
            ...
            array[startingIndex + (Cartesian3.Cartesian3.packedLength * 2)] = when.defaultValue(value._offsetAttribute, -1);
        ...
        BoxOutlineGeometry.unpack = function(array, startingIndex, result) {
            ...
            var offsetAttribute = array[startingIndex + Cartesian3.Cartesian3.packedLength * 2];
