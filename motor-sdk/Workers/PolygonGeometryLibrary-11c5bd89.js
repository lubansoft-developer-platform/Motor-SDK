...
define(['exports', './when-45f3d25d', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './Matrix4-c65e6a1b', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab', './GeometryAttributes-9d45f9e2', './GeometryPipeline-57d51dc8', './IndexDatatype-e52361bd', './arrayRemoveDuplicates-24a803e7', './ArcType-39be7a32', './EllipsoidRhumbLine-4bc7760a', './PolygonPipeline-31f67db0'], function (exports, when, Cartesian3, Cartesian2, Matrix4, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, GeometryPipeline, IndexDatatype, arrayRemoveDuplicates, ArcType, EllipsoidRhumbLine, PolygonPipeline) { 'use strict';
    ...
    /**
        ...
        PolygonGeometryLibrary.computeHierarchyPackedLength = function(polygonHierarchy) {
            ...
            while (stack.length > 0) {
                ...
                if (when.defined(positions)) {
                    numComponents += positions.length * Cartesian3.Cartesian3.packedLength;
                }
        ...
        PolygonGeometryLibrary.unpackPolygonHierarchy = function(array, startingIndex) {
            ...
            for (var i = 0; i < positionsLength; ++i, startingIndex += Cartesian3.Cartesian3.packedLength) {
        ...
        var distanceScratch = new Cartesian3.Cartesian3();
        function getPointAtDistance(p0, p1, distance, length) {
            Cartesian3.Cartesian3.subtract(p1, p0, distanceScratch);
            Cartesian3.Cartesian3.multiplyByScalar(distanceScratch, distance / length, distanceScratch);
            Cartesian3.Cartesian3.add(p0, distanceScratch, distanceScratch);
        ...
        PolygonGeometryLibrary.subdivideLineCount = function(p0, p1, minDistance) {
            ...
            var countDivide = Math.max(0, Math.ceil(Cartesian3.CesiumMath.log2(n)));
        ...
        var scratchCartesian0 = new Cartesian3.Cartesian3();
        ...
        PolygonGeometryLibrary.subdivideLine = function(p0, p1, minDistance, result) {
            ...
            var length = Cartesian3.Cartesian3.distance(p0, p1);
        ...
        var scaleToGeodeticHeightN1 = new Cartesian3.Cartesian3();
        var scaleToGeodeticHeightN2 = new Cartesian3.Cartesian3();
        var scaleToGeodeticHeightP1 = new Cartesian3.Cartesian3();
        var scaleToGeodeticHeightP2 = new Cartesian3.Cartesian3();
        ...
        PolygonGeometryLibrary.scaleToGeodeticHeightExtruded = function(geometry, maxHeight, minHeight, ellipsoid, perPositionHeight) {
            ...
            if (when.defined(geometry) && when.defined(geometry.attributes) && when.defined(geometry.attributes.position)) {
                ...
                for ( var i = 0; i < length; i += 3) {
                    ...
                    n2 = Cartesian3.Cartesian3.multiplyByScalar(n1, minHeight, n2);
                    n2 = Cartesian3.Cartesian3.add(p2, n2, n2);
                    positions[i + length] = n2.x;
                    positions[i + 1 + length] = n2.y;
                    positions[i + 2 + length] = n2.z;

                    if (perPositionHeight) {
                        p2 = Cartesian3.Cartesian3.clone(p, p2);
                    }
                    n2 = Cartesian3.Cartesian3.multiplyByScalar(n1, maxHeight, n2);
                    n2 = Cartesian3.Cartesian3.add(p2, n2, n2);
                    positions[i] = n2.x;
                    positions[i + 1] = n2.y;
                    positions[i + 2] = n2.z;
        ...
        PolygonGeometryLibrary.polygonOutlinesFromHierarchy = function(polygonHierarchy, scaleToEllipsoidSurface, ellipsoid) {
            ...
            while (queue.length !== 0) {
                ...
                outerRing = arrayRemoveDuplicates.arrayRemoveDuplicates(outerRing, Cartesian3.Cartesian3.equalsEpsilon, true);
                ...
                for (i = 0; i < numChildren; i++) {
                    ...
                    holePositions = arrayRemoveDuplicates.arrayRemoveDuplicates(holePositions, Cartesian3.Cartesian3.equalsEpsilon, true);
        ...
        var computeBoundingRectangleCartesian3 = new Cartesian3.Cartesian3();
        var computeBoundingRectangleQuaternion = new Transforms.Quaternion();
        var computeBoundingRectangleMatrix3 = new Matrix4.Matrix3();
        PolygonGeometryLibrary.computeBoundingRectangle = function (planeNormal, projectPointTo2D, positions, angle, result) {
            ...
            var textureMatrix = Matrix4.Matrix3.fromQuaternion(rotation, computeBoundingRectangleMatrix3);
            ...
            for ( var i = 0; i < length; ++i) {
                var p = Cartesian3.Cartesian3.clone(positions[i], computeBoundingRectangleCartesian3);
                Matrix4.Matrix3.multiplyByVector(textureMatrix, p, p);
        ...
        PolygonGeometryLibrary.computeWallGeometry = function(positions, ellipsoid, granularity, perPositionHeight, arcType) {
            ...
            for (i = 0; i < length; i++) {
                ...
                p1 = Cartesian3.Cartesian3.fromArray(edgePositions, UL * 3, p1Scratch);
                p2 = Cartesian3.Cartesian3.fromArray(edgePositions, UR * 3, p2Scratch);
                if (Cartesian3.Cartesian3.equalsEpsilon(p1, p2, Cartesian3.CesiumMath.EPSILON10, Cartesian3.CesiumMath.EPSILON10)) {
                    //skip corner
                    continue;
                }
...
//# sourceMappingURL=PolygonGeometryLibrary-11c5bd89.js.map
