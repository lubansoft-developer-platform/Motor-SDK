...
define(['./when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './RuntimeError-86da6af2', './Rectangle-c7d55cfa', './WebGLConstants-3660bc8f', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab', './GeometryAttributes-9d45f9e2', './IndexDatatype-e52361bd', './GeometryOffsetAttribute-f755a5cb', './EllipsoidRhumbLine-4bc7760a', './PolygonPipeline-d22f3330', './RectangleGeometryLibrary-2696ecaf'], function (when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, RuntimeError, Rectangle, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, EllipsoidRhumbLine, PolygonPipeline, RectangleGeometryLibrary) { 'use strict';
    ...
    var bottomBoundingSphere = new BoundingSphere.BoundingSphere();
         ...
         * @type {Number}
         */
        RectangleOutlineGeometry.packedLength = Rectangle.Rectangle.packedLength + Cartesian2.Ellipsoid.packedLength + 5;
        ...
        RectangleOutlineGeometry.createGeometry = function(rectangleGeometry) {
            ...
            if ((Cartesian3.CesiumMath.equalsEpsilon(rectangle.north, rectangle.south, Cartesian3.CesiumMath.EPSILON10) ||
                 (Cartesian3.CesiumMath.equalsEpsilon(rectangle.east, rectangle.west, Cartesian3.CesiumMath.EPSILON10)))) {
                return undefined;
            }
