...
define(['./when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Matrix4-c65e6a1b', './RuntimeError-86da6af2', './Rectangle-c7d55cfa', './WebGLConstants-3660bc8f', './ComponentDatatype-86703c58', './GeometryAttribute-70b679fd', './PrimitiveType-30fa6f85', './Transforms-7d49a8ab', './GeometryAttributes-9d45f9e2', './AttributeCompression-1e177d5e', './GeometryPipeline-57d51dc8', './EncodedCartesian3-7b803d4a', './IndexDatatype-e52361bd', './IntersectionTests-8855da40', './Plane-1875afb4', './VertexFormat-a00562ee', './GeometryInstance-734856d8', './arrayRemoveDuplicates-24a803e7', './BoundingRectangle-c7afec11', './EllipsoidTangentPlane-3e14dd4d', './OrientedBoundingBox-c5c382aa', './CoplanarPolygonGeometryLibrary-561cedf6', './ArcType-39be7a32', './EllipsoidRhumbLine-4bc7760a', './PolygonPipeline-d22f3330', './PolygonGeometryLibrary-c7aa9cd4'], function (when, Check, Cartesian3, Cartesian2, BoundingSphere, Matrix4, RuntimeError, Rectangle, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, Transforms, GeometryAttributes, AttributeCompression, GeometryPipeline, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane, VertexFormat, GeometryInstance, arrayRemoveDuplicates, BoundingRectangle, EllipsoidTangentPlane, OrientedBoundingBox, CoplanarPolygonGeometryLibrary, ArcType, EllipsoidRhumbLine, PolygonPipeline, PolygonGeometryLibrary) { 'use strict';
    ...
    var axis1Scratch = new Cartesian3.Cartesian3();
    var axis2Scratch = new Cartesian3.Cartesian3();
    var quaternionScratch = new Transforms.Quaternion();
    var textureMatrixScratch = new Matrix4.Matrix3();
    var tangentRotationScratch = new Matrix4.Matrix3();
    var surfaceNormalScratch = new Cartesian3.Cartesian3();
    ...
    function createGeometryFromPolygon(
        ...
        var indices = PolygonPipeline.PolygonPipeline.triangulate(
            polygon.positions2D,
            polygon.holes
        );
        ...
        if (stRotation !== 0.0) {
            ...
            if (vertexFormat.tangent || vertexFormat.bitangent) {
                ...
                var tangentRotation = Matrix4.Matrix3.fromQuaternion(
                    rotation,
                    tangentRotationScratch
                );

                tangent = Cartesian3.Cartesian3.normalize(
                    Matrix4.Matrix3.multiplyByVector(tangentRotation, tangent, tangent),
                    tangent
                );
        ...
        for (var i = 0; i < length; i++) {
            ...
            if (vertexFormat.st) {
                ...
                var stx = Cartesian3.CesiumMath.clamp(st.x / boundingRectangle.width, 0, 1);
                var sty = Cartesian3.CesiumMath.clamp(st.y / boundingRectangle.height, 0, 1);
    ...
    CoplanarPolygonGeometry.createGeometry = function (polygonGeometry) {
        ...
        if (
            !Cartesian3.Cartesian3.equalsEpsilon(
                ...
                Cartesian3.CesiumMath.EPSILON6
            )
        ) {
