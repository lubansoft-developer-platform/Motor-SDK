...
define(['exports', './when-45f3d25d', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './EllipsoidTangentPlane-3e14dd4d', './PolygonPipeline-31f67db0', './PolylinePipeline-e758f102'], function (exports, when, Cartesian3, Cartesian2, EllipsoidTangentPlane, PolygonPipeline, PolylinePipeline) { 'use strict';
    ...
    WallGeometryLibrary.computePositions = function (
        ...
        if (wallPositions.length >= 3) {
            ...
            if (
                ...
                PolygonPipeline.WindingOrder.CLOCKWISE
            ) {
        ...
        var minDistance = Cartesian3.CesiumMath.chordLength(
            granularity,
...
//# sourceMappingURL=WallGeometryLibrary-d6a61982.js.map
