...
define(['exports', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './Matrix4-c65e6a1b', './OrientedBoundingBox-153a0c83'], function (exports, Check, Cartesian3, Cartesian2, Matrix4, OrientedBoundingBox) { 'use strict';
    ...
    /**
        ...
        var scratchIntersectionPoint = new Cartesian3.Cartesian3();
        var scratchXAxis = new Cartesian3.Cartesian3();
        var scratchYAxis = new Cartesian3.Cartesian3();
        var scratchZAxis = new Cartesian3.Cartesian3();
        ...
        CoplanarPolygonGeometryLibrary.validOutline = function(positions) {
            ...
            var xAxis = Matrix4.Matrix3.getColumn(halfAxes, 0, scratchXAxis);
            var yAxis = Matrix4.Matrix3.getColumn(halfAxes, 1, scratchYAxis);
            var zAxis = Matrix4.Matrix3.getColumn(halfAxes, 2, scratchZAxis);

            var xMag = Cartesian3.Cartesian3.magnitude(xAxis);
            var yMag = Cartesian3.Cartesian3.magnitude(yAxis);
            var zMag = Cartesian3.Cartesian3.magnitude(zAxis);
        ...
        function projectTo2D(position, center, axis1, axis2, result) {
            var v = Cartesian3.Cartesian3.subtract(position, center, scratchIntersectionPoint);
            var x = Cartesian3.Cartesian3.dot(axis1, v);
            var y = Cartesian3.Cartesian3.dot(axis2, v);
...
//# sourceMappingURL=CoplanarPolygonGeometryLibrary-d5f0a22e.js.map
