...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Transforms-7d49a8ab'], function (exports, when, Check, Cartesian3, Transforms) { 'use strict';
    ...
    function hue2rgb(m1, m2, h) {
        ...
        Color.fromRandom = function(options, result) {
            ...
            if (!when.defined(red)) {
                ...
                red = minimumRed + (Cartesian3.CesiumMath.nextRandomNumber() * (maximumRed - minimumRed));
            }
            ...
            if (!when.defined(green)) {
                ...
                //>>includeEnd('debug');
                green = minimumGreen + (Cartesian3.CesiumMath.nextRandomNumber() * (maximumGreen - minimumGreen));
            }
            ...
            if (!when.defined(blue)) {
                ...
                blue = minimumBlue + (Cartesian3.CesiumMath.nextRandomNumber() * (maximumBlue - minimumBlue));
            }
            ...
            if (!when.defined(alpha)) {
                ...
                alpha = minimumAlpha + (Cartesian3.CesiumMath.nextRandomNumber() * (maximumAlpha - minimumAlpha));
            }
        ...
        Color.lerp = function(start, end, t, result) {
            ...
            result.red = Cartesian3.CesiumMath.lerp(start.red, end.red, t);
            result.green = Cartesian3.CesiumMath.lerp(start.green, end.green, t);
            result.blue = Cartesian3.CesiumMath.lerp(start.blue, end.blue, t);
            result.alpha = Cartesian3.CesiumMath.lerp(start.alpha, end.alpha, t);
            return result;
        };
        ...
        Color.SUNLIGHT = Object.freeze(new Color(1, 0.972549, 0.929412, 1));

    exports.Color = Color;

});
//# sourceMappingURL=Color-cbe4364d.js.map
