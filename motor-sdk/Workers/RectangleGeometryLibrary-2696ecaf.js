...
define(['exports', './when-45f3d25d', './Check-34538dad', './Cartesian3-e69091b9', './Cartesian2-7a44370a', './BoundingSphere-bacc5cb6', './Rectangle-c7d55cfa', './GeometryAttribute-70b679fd'], function (exports, when, Check, Cartesian3, Cartesian2, BoundingSphere, Rectangle, GeometryAttribute) { 'use strict';
    ...
    var cos = Math.cos;
        ...
        var nwCartesian = new Cartesian3.Cartesian3();
        var centerScratch = new Cartesian2.Cartographic();
        var centerCartesian = new Cartesian3.Cartesian3();
        ...
        function getRotationOptions(nwCorner, rotation, granularityX, granularityY, center, width, height) {
            ...
            nwCartesian = Cartesian3.Cartesian3.subtract(nwCartesian, centerCartesian, nwCartesian);
            ...
            nwCartesian = Cartesian3.Cartesian3.add(nwCartesian, centerCartesian, nwCartesian);
        ...
        RectangleGeometryLibrary.computeOptions = function(rectangle, granularity, rotation, stRotation, boundingRectangleScratch, nwCornerResult, stNwCornerResult) {
            ...
            if (north === Cartesian3.CesiumMath.PI_OVER_TWO) {
                northCap = true;
            }
            if (south === -Cartesian3.CesiumMath.PI_OVER_TWO) {
                southCap = true;
            }
            ...
            var dy = north - south;
            if (west > east) {
                dx = (Cartesian3.CesiumMath.TWO_PI - west + east);
            } else {
                dx = east - west;
            }
            ...
            var nwCorner = Rectangle.Rectangle.northwest(rectangle, nwCornerResult);
            var center = Rectangle.Rectangle.center(rectangle, centerScratch);
            if (rotation !== 0 || stRotation !== 0) {
                if (center.longitude < nwCorner.longitude) {
                    center.longitude += Cartesian3.CesiumMath.TWO_PI;
                }
            ...
            var boundingRectangle = Rectangle.Rectangle.clone(rectangle, boundingRectangleScratch);
            ...
            if (rotation !== 0) {
                ...
                if (north < -Cartesian3.CesiumMath.PI_OVER_TWO || north > Cartesian3.CesiumMath.PI_OVER_TWO ||
                    south < -Cartesian3.CesiumMath.PI_OVER_TWO || south > Cartesian3.CesiumMath.PI_OVER_TWO) {
            ...
            if (stRotation !== 0) {
                ...
                var stNwCorner = Rectangle.Rectangle.northwest(boundingRectangle, stNwCornerResult);
...
//# sourceMappingURL=RectangleGeometryLibrary-2696ecaf.js.map
